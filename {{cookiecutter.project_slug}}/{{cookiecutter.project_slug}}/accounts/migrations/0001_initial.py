# Generated by Django 3.0.3 on 2020-02-06 22:12
...
import {{ cookiecutter.project_slug }}.accounts.managers.user
import {{ cookiecutter.project_slug }}.common.utils
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(error_messages={'unique': 'A user with this email address already exists.'}, max_length=255, unique=True, verbose_name='email address')),
            ...
            managers=[
                ('objects', {{ cookiecutter.project_slug }}.accounts.managers.user.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Session',
